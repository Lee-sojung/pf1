...
key: AIzaSyCaMHpUSfzx7r4sjOMvOrs9nhRpKOXtcKo

maxResults: 5; //호출할 데이터 갯수,

playlistId: PLYOPkdUKSFgWPLsAWpqRpK0cCiAGdxi-Y
*/

const vidList = document.querySelector(".vidList");
const key = "AIzaSyC7rA3bw12Oogstpe_sGmJFYrmr47anoZ4";
const playListId = "PLGzNH5a9hxjZO9KWrgdMj5jF4t8axGESw";
const num = 9;
